          ...
          <CollapseBody>
            <View style={{flex: 1, flexDirection: 'row'}}>
              ...
              <CircleViewClick
                navigation={this.props.navigation}
                categoryid="83"
                source={IMAGES.fiction}
              />
              <CircleViewClick
                navigation={this.props.navigation}
                categoryid="90"
                source={IMAGES.open_letter}
              />
              <CircleViewClick
                navigation={this.props.navigation}
                categoryid="91"
                source={IMAGES.verses}
              />
              <CircleViewClick
                navigation={this.props.navigation}
                categoryid="81"
                source={IMAGES.writers_launge}
              />
              <CircleViewClick
                navigation={this.props.navigation}
                categoryid="173"
                source={IMAGES.gujarati}
              />
            </View>
          </CollapseBody>
        </Collapse>
          ...
          <CollapseBody>
            <View style={{flex: 1, flexDirection: 'row'}}>
              <CircleViewClick
                navigation={this.props.navigation}
                categoryid="133"
                source={IMAGES.allumni}
              />
              <CircleViewClick
                navigation={this.props.navigation}
                categoryid="134"
                source={IMAGES.ddu_speaks}
              />
              <CircleViewClick
                navigation={this.props.navigation}
                categoryid="132"
        ...
        <Collapse style={{flexDirection: 'row'}}>
          <CollapseHeader>
            <CircleViewClick
              categoryid="200"
              navigation={this.props.navigation}
              source={IMAGES.past_year_papers}
            />
          </CollapseHeader>
        </Collapse>
      </ScrollView>
