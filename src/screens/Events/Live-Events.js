...
export default function LiveEvents() {
  ...
  useEffect(() => {
    fetch(
      'https://raw.githubusercontent.com/ddu-connect/dduconnect_database/master/Events.json',
    )
      ...
      .then(responseJson => {
        ...
        let newArray = responseJson.filter(function (item) {
          return (
            moment().isAfter(moment(item['Start-date'], 'DD-MM-YYYY')) &&
            moment().isBefore(moment(item['End-date'], 'DD-MM-YYYY'))
          );
        });
        setData(newArray);
        setLoading(false);
