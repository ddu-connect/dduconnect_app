        ...
        <View style={{flex: 3, backgroundColor: 'powderblue'}}>
          ...
          <View style={styles.container}>
            ...
            <TouchableOpacity
              ...
              onPress={() => Linking.openURL('mailto:dduconnect@gmail.com')}>
        ...
        <View style={{flex: 2, flexDirection: 'row'}}>
          <View style={{flex: 1, backgroundColor: '#ffa31a', padding: 10}}>
            ...
            <Text
              style={styles.text}
              onPress={() =>
                Linking.openURL('https://goo.gl/maps/VAe1e6xiHypuHWfd9')
              }>
            ...
            <View
              ...
              <View style={{height: 40, width: 40}}>
                <TouchableHighlight
                  ...
                  onPress={() =>
                    Linking.openURL(
                      'https://www.linkedin.com/company/ddu-connect/about/',
                    )
                  }>
                  {/* <Image source={require('../../assets/images/Li.png')} style={{height:40, width:40}} /> */}
                  <SocialIcon button type="linkedin" />
                </TouchableHighlight>
              </View>
              <View style={{height: 40, width: 40}}>
                <TouchableHighlight
                  ...
                  onPress={() =>
                    Linking.openURL(
                      'https://www.youtube.com/channel/UCL_HeXMG8OnytZZtIRgkpQA',
                    )
                  }>
