      ...
      <View
        ...
        <ScrollView style={{flex: 1, padding: 40}}>
          <Text
            ...
            the country and alumni of the university. DDU Connect has grown
            ...
            witnessed a Guinness record being established. Evolving from a 20
            page tabloid in to a 'GoGreen' concept, Connect celebrates one year
            into the official digital platform of the university. With all due
            support, it has leapt into another year of excitement, challenges
            and venture with the vision to synergize individuality.
          </Text>
        </ScrollView>
      </View>
    );
